...
export const DASHBOARD_ORDER_STATUS_TONE = {
  نشط: "success",
  مجدولة: "info",
  مكتمل: "neutral",
  متوقف: "danger",
...
export const PROVIDER_REQUEST_STATUS_TONE = {
  "بانتظار التحقق": "info",
...
export const PROVIDER_DOCUMENT_STATUS_TONE = {
  "تم التحقق": "success",
...
export const PROVIDER_SERVICE_STATUS_TONE = {
  نشط: "success",
  "غير نشط": "danger",
};
