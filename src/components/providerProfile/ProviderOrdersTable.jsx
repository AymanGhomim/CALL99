...
export default function ProviderOrdersTable({ rows, totalCount, currentPage = 1, totalPages = 1, onView }) {
  const columns = [
    { key: "orderNo", label: "رقم الطلب", cellClassName: "font-extrabold text-[#75262d]" },
    { key: "customer", label: "العميل", cellClassName: "font-semibold text-[#3d3434]" },
